              ...
              <div className="modal-body p-4">
                <div className="row g-4">
                  <div className="col-md-4">
                    ...
                    >
                      <div
                        className="preview-box border rounded-3 mb-3 shadow-sm"
                        style={{
                          height: "200px",
                          overflowY: "auto",
                          padding: "4px",
                      ...
                      >
                        {formData.previews?.length > 0 ? (
                          ...
                          <div className="h-100 d-flex align-items-center justify-content-center bg-light text-muted small">
                            No Image Selected
                          </div>
                        )}
                      </div>
                        ...
                        <div className="d-flex flex-wrap gap-2">
                          {allAvailableSizes.map((s) => (
                            <button
                              type="button"
                              key={s}
                              className={`btn btn-sm rounded-pill fw-bold transition-all px-3 ${
