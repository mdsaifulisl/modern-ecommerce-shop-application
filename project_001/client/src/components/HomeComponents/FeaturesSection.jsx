...
const FeaturesSection = () => {
  ...
  return (
    <section className="py-5 animate-fade-in" style={{ backgroundColor: "var(--d-main-bg-color)" }}>
      <div className="container">
        <div className="text-center mb-5">
          <h2 className="fw-bold" style={{ color: "var(--text-color)" }}>Why Shop With Us?</h2>
          <div 
            className="mx-auto mt-2" 
            style={{ width: "60px", height: "4px", backgroundColor: "var(--green-color)", borderRadius: "2px" }}
          ></div>
        </div>
          ...
          {features.map((feature, idx) => (
            <div className="col-6 col-lg-3" key={idx}>
              ...
              >
                ...
                <h6 className="fw-bold mb-2" style={{ color: "var(--text-color)" }}>
                  {feature.title}
                </h6>
                <p className="small mb-0 opacity-75" style={{ color: "var(--text-color)", lineHeight: "1.5" }}>
                  {feature.text}
                </p>
              </div>
            </div>
